...
/**
 * Strings for component 'mlbackend_phpessec'
 *
...
$string['confusionmatrix'] = 'Confusion matrix for evaluated model #{$a->i} {$a->matrix}';
$string['datasetsizelimited'] = 'Only part of the dataset has been evaluated due to its size. Set $CFG->mlbackend_phpessec_no_memory_limit if you are confident that your system can cope with a {$a} dataset.';
...
$string['recall'] = 'Recall {$a}';
$string['recalls'] = 'Recalls for all the evaluated models {$a}';
